    ...
    return (
        <AuthenticatedLayout user={auth.user}>
            ...
            <div className="relative min-h-screen bg-[#f8fafc] dark:bg-[#050b1a] text-slate-800 dark:text-slate-200 overflow-hidden font-sans transition-colors duration-300">
                {/* Ambient background — light mode soft gradient, dark mode glows */}
                ...
                <main className="relative z-10 max-w-6xl mx-auto px-6 py-12 md:px-12 space-y-10">
                    ...
                    <header className="flex flex-col md:flex-row md:items-end md:justify-between gap-4">
                        <div>
                            <h1 className="text-3xl md:text-4xl font-bold tracking-tight text-slate-900 dark:text-white">
                                Welcome back, <span className="bg-gradient-to-r from-violet-600 to-blue-500 dark:from-blue-400 dark:to-cyan-300 bg-clip-text text-transparent">{auth.user.name.split(' ')[0]}</span>!
                            </h1>
                    ...
                    <div className="grid gap-6 lg:grid-cols-3">
                        ...
                        <div className="lg:col-span-2">
                            <div className="bg-white dark:bg-[#0a101f] border border-slate-200 dark:border-blue-900/30 rounded-3xl p-8 shadow-md dark:shadow-none transition-all duration-300 hover:shadow-lg">
                                <div className="flex items-center gap-3 mb-6">
                                    <div className="w-8 h-8 rounded-xl bg-indigo-100 dark:bg-blue-500/10 border border-indigo-200 dark:border-blue-500/20 flex items-center justify-center">
                                        <svg className="w-4 h-4 text-indigo-500 dark:text-blue-400" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                                ...
                                <div className="aspect-video bg-indigo-50/60 dark:bg-[#050b1a] rounded-2xl border-2 border-dashed border-indigo-200/70 dark:border-blue-900/50 flex flex-col items-center justify-center gap-4 transition-colors duration-300 shadow-inner">
                                    <div className="w-12 h-12 rounded-full bg-white dark:bg-blue-500/10 border border-indigo-200 dark:border-blue-500/20 flex items-center justify-center shadow-sm">
                                        <svg className="w-6 h-6 text-indigo-400 dark:text-blue-400 animate-pulse" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
                                ...
                                <div className="mt-6 flex justify-end">
                                    <button className="bg-gradient-to-r from-indigo-600 to-blue-500 text-white font-bold px-6 py-2.5 rounded-xl text-sm hover:brightness-110 hover:scale-[1.02] active:scale-[0.98] transition-all shadow-lg shadow-indigo-500/20">
                                        Submit Answer
                                    </button>
                                </div>
                            </div>
                        ...
                        <div className="bg-white dark:bg-[#0a101f] border border-slate-200 dark:border-blue-900/30 rounded-3xl p-6 pb-8 shadow-md dark:shadow-2xl flex flex-col transition-colors duration-300">
                            <div className="flex items-center justify-between mb-6">
                                <h3 className="text-lg font-bold text-slate-900 dark:text-white transition-colors duration-300">Leaderboard</h3>
                                <svg className="w-5 h-5 text-indigo-500 dark:text-cyan-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        {[
                            ...
                            <div key={label} className="bg-white dark:bg-[#0a101f] border border-slate-200 dark:border-blue-900/30 rounded-2xl p-5 shadow-md dark:shadow-none hover:shadow-lg hover:-translate-y-1 dark:hover:shadow-[0_0_20px_rgba(59,130,246,0.08)] transition-all duration-300">
